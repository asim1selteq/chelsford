...
import Laserservices from "./Pages/AllServices/Laserservices";
import Beautyservice from "./Pages/AllServices/Beautyservice";
import Medicalservices from "./Pages/AllServices/Medicalservices";
import Onlineservices from "./Pages/AllServices/Onlineservices";
import Eventspage from "./Pages/Eventspage/Eventspage";
import Franchise from "./Pages/FranchisePage/Franchise";
import International from "./Pages/InternationalPage/International";
...
const App = ({
  ...
  return (
    <>
      {/* whatsapp div */}
      {/* <div class="elfsight-app-c57f501d-a1ea-4cc6-841b-e99a0d9194a1"></div> */}
      ...
      <Router history={history}>
        ...
        >
          ...
          <Switch>
            ...
            <FAEGuardedRoute
              path="/laser-courses"
              component={Laserservices}
              exact
              auth={true}
            />
            <FAEGuardedRoute
              path="/beauty-courses"
              component={Beautyservice}
              exact
              auth={true}
            />
            <FAEGuardedRoute
