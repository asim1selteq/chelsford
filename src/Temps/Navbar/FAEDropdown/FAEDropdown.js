...
export const FAEDropdown = ({
  ...
  return (
    <>
    <div className="col-md-12 text-end g-0" style={{marginBottom:"-4px"}}>
    <a href="/about-us" className="g-0" style={{color:"black", textDecoration:"none", fontSize:"14px"}}>About Us</a> 
    </div>
      <div
