...
import GetInTouchForm from "../../components/banner/getintouchform";
import "react-multi-carousel/lib/styles.css";
import style from "./doneByAbdulRehman.module.css";
...
const ServiceContentPage = ({
  ...
  document.title = `${serviceUrlName} | Chelsford `;
  ...
  // all data coming from json file 
  useEffect(() => {
  ...
  //  destructure array coming from json 
  const { course_information, summary_description, header_key_info, course_module, featur_content, instruction_content, page_link, what_next, crousal_images } = contentData[0] || {}
  // console.log("image from json--------------------->",crousal_images)


  const placeholderImage = 'https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/placeholder.jpg'
  ...
  return (
    <>
      {(loading) ?
        ...
        :
        (<div style={{ paddingBottom: padding, overflowX: "hidden" }}>
            ...
            <div className="course-overlay">
              <div className="container">
                <div className="main-text">
                  <h1 className="font_h1">{serviceName}</h1>
                  <p>
                    ...
                    <button className="my-1 btn main-btns">
                      <div className="pb-2 d-flex">
                        ...
                        <p className="px-2 banner-boxes-tex justify-content-start text-start">
                          Price
                          <br />
                          <span className="">  £ {serviceDescription?.maxPrice} inclusive </span>
                        </p>
                      </div>
                    </button>
                  </div>
          ...
          {/* <img className="img-fluid" src={crousal_images[0]?.image} alt="image_crash" /> */}
          {/* crousal_images[0] */}
          ...
          {/* summary detail page       */}
          {/* h-auto p-md-5 p-sm-2 my-text-sect */}
          <section className={style.fullContent}>
            <div>
              <div className={style.fullContent_summary}>
                <strong>Course Summary</strong>
                <p>{summary_description}</p></div>
              <div className={style.fullContent_getintouch}><GetInTouchForm /></div>
            </div>
          </section>

          {/* <section className="h-auto py-md-5 py-sm-2" style={{backgroundColor:"#fafafa"}}>
  <div className="container fluid">
    <div className="row">
      <div className="px-md-5 px-sm-2 col-md-8 order-md-1 order-1 my-md-auto">
        <p className="mx-md-5">{summary_description}</p>
      </div>
      <div className="col-md-4 order-md-2 order-2">
        <div className="d-block d-md-none" style={{backgroundImage: `url(${mobile_bg_image})`, width:"100%"}}>
          <GetInTouchForm />
        </div>
        <div className="d-none d-md-block">
          ...
          {contentData?.length !== 0 &&
            <>
              {(course_module?.length !== 0 && course_module !== undefined) && <section id="Course_module" className="py-5 course_module">
                <div className="container">
                  <h4 className="pt-3 pb-5 text-center"><b>Course Modules</b></h4>
              ...
              {/* {crousal_images && crousal_images.length > 0 && <div className="col-md-12 px-md-5 mt-4 mb-4">
                <Carousel
                  autoPlaySpeed={1000}
                  infinite={true}
                  autoPlay={true}
                  ...
                  {crousal_images?.map((item, index) => {
                    return (
                      <div className="col-md-12 px-3 text-center">
                        <img className="img-fluid img_set_size" src={item?.image} alt="image_crash" />
                      </div>
                    )
                  })}
              ...
              {crousal_images && crousal_images.length > 0 &&
                <Slider data={crousal_images} />
              }
              {/* test crousel end */}
                ...
                <section id="complete_beauty" className="complete_beauty ">
                  <div className="container-fluid">
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <FAEImage placeholder={placeholderImage}
                          src={`https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/${featur_content?.image}`}
                        // src={getFileSrcFromPublicFolderSpcialLHR(featur_content?.image)}  
                        />
                    ...
                    <div className="container-fluid">
                      <div className="row">
                        <div className="col-md-12 col-sm-12">
                          ...
                          <p >In this course, you'll learn a variety of new skills that will help launch you into a rewarding career. Have a look at the course information to get an idea of what we’ll cover:</p>
                        </div>
                          ...
                          return (
                            <li key={index}>
                              <div className="tick-icon">
                                <span><img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/tick.svg' height={20} width={20} alt='tick icon' /></span>
                              </div>
                              <div>
                ...
                <div className="row get-qualified">
                  <div className="col-md-7">
                    <div className="coursesDiscriptionCol">
                      <h2><b>Get Qualified and Start Today</b></h2>
          ...
          <div className="contact-source">
            <div className="contact-btns">
              <button type="button" className="btn btn-default" ><a href="mailto:team@chelsford.com" ><img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/chat.png' alt="call us" /></a></button>
              <button type="button" className="btn btn-default " onClick={bookingHandler} >View Dates & Book</button>
              <button type="button" className="btn btn-default" ><a href="tel:0800 955 0054" ><img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/phone-icon.png' alt="chat us" /></a></button>
            </div>
          </div>
        </div>
        )}
