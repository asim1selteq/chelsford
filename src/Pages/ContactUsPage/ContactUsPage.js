      ...
      <div className="">
        <div className="destop-banner">
          <div className="image-container">
           <img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/contact-banner.webp' width="100%" className="img-fluid" alt="Responsive image" />
          </div>
      </div>

    <div className="mobile-banner">
        <div className="image-container">
            <img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/contact-banner-mob.webp' width="100%" className="img-fluid" alt="Responsive image" />
        </div>
    </div>
        ...
        <div className="formContainer">
          ...
          <div id="response" style={{width:"100%"}}></div>
            ...
            <div className="imageContainer"> 
                <img src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/Contact-us-inner.webp' alt=""  />
            </div>
          </div>
      </div>
   </div>
