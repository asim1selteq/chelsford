...
//   https://1864597015.rsc.cdn77.org/chelsford/images/assets/PublicFolder/placeholder.jpg
  return (
            ...
            {newcard? (
                   ...
                   <div className="row">
                       <div className="col-md-10 col-10 bg_card1_s1">
                           <div className="p-3 row">
                               ...
                               <FAEImage placeholder={placeholderImage} src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/swipecard.png' className="img-fluid" />
                               </div>
                ...
                <div className="text-right col-md-2 col-2 bg_card2_s2 ">
                    ...
                    <div className="col-md-10 col-10 bg_card2_s1">
                        <div className="p-3 row">
                           <div className="p-0 col-md-6">
                                <FAEImage placeholder={placeholderImage} src='https://1864597015.rsc.cdn77.org/chelsford/images/assets/specialLHR/swipe2.png' className="img-fluid" />
                            </div>
                           <div className="m-auto col-md-6">
