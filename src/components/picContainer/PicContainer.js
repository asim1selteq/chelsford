...
const PicContainer = () => {
  ...
  const onSbmit = (e) => {
    ...
    postRequest({ customerEmail, customerName, message, subject , isChelsford: true}).then(res => {
  ...
  return (
    <div className="main__Image__Container">
      <video
        ...
        width="100%"
        height="100%"
        src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/chelsford-index-banner-video.mp4"
        alt={"alt"}
      />
     <video
        ...
        width="100%"
        height="100%"
        src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/chelsford-home-loader.mp4"
        alt={"alt"}
      />

      <div className="bannerContent2 d-md-block d-none">
