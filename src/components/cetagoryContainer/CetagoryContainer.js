          ...
          <div className="row">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/laser.webp" alt="laser"/>
              </div>
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/level4.jpg" alt="level4"/>
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/girltatoo.webp" alt="girltatoo" />
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/beauty.webp" alt="beauty"/>
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/foundation.jpg" alt="foundation"/>
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/laserskin.webp" alt="laserskin"/>
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
            ...
            <div className="col-md-3 mt-3">
              ...
              <div className="col-md-12" style={{boxShadow:"1px 1px 7px 7px rgba(211, 211, 211, 0.449)", borderRadius:"5px",height:"22vh",overflow:"hidden"}}>
                <img style={{borderTopRightRadius:"5px", borderTopLeftRadius:"5px"}} className="img-fluid" src="https://1864597015.rsc.cdn77.org/chelsford/images/assets/images/blemish.jpg" alt="blemish"/>
              </div>
              <div style={{color:"white", backgroundColor:"#1E185F", borderBottomLeftRadius:"5px",borderBottomRightRadius:"5px"}} className="col-md-12 pt-3 pb-2 text-center">
